...
function DownloadApp() {
  return (
    <div className='my-8 bg-white rounded-xl'>
        <div className='grid lg:grid-cols-2 grid-cols-1 p-3 gap-8'>

<div className='flex justify-center items-center'>
    <div className='text-customGray w-5/6 mx-auto  '>
        <h2 className='font-bold text-4xl tracking-[-2.5%] leading-[50px]'>Download the BilmaPay App to get started</h2>
