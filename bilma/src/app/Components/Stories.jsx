    ...
    <div>
      <div>
        <div className="text-customGray text-center ">
          <h2 className="font-bold text-4xl lg:w-5/6 mx-auto w-full tracking-[-2.5%] leading-[50px]">
            Real Stories From Satisfied Customers
          </h2>

          <p className="py-5 text-xl ">See how BilmaPay is making an Impact</p>
        </div>
        <div className="my-8 grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-12">
          <TestimonialCard
            name="Obi Pascal"
